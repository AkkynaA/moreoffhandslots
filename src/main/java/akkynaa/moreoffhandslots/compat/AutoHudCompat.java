...
public class AutoHudCompat implements AutoHudApi {
    ...
    static class WrappedOffhandHudRenderer implements IOffhandHudRenderer {
        ...
        public void renderOffhandHud(GuiGraphics guiGraphics, float  partialTicks, int screenWidth, int screenHeight) {
            AutoHudCompat.COMPONENT_WRAPPER.wrap(guiGraphics, () -> this.parent.renderOffhandHud(guiGraphics,  partialTicks, screenWidth, screenHeight));
        }

        @Override
        public void renderHotbarStyleOffhand(GuiGraphics guiGraphics, float partialTicks, LocalPlayer player, int screenWidth, int screenHeight, List<ItemStack> items) {
            AutoHudCompat.BACKGROUND_WRAPPER.wrap(guiGraphics, () -> this.parent.renderHotbarStyleOffhand(guiGraphics, partialTicks, player, screenWidth, screenHeight, items));
        }

        @Override
        public void renderDefaultStyleOffhand(GuiGraphics guiGraphics, float partialTicks, LocalPlayer player, int screenWidth, int screenHeight, ItemStack prevItem, ItemStack currentItem, ItemStack nextItem) {
            AutoHudCompat.BACKGROUND_WRAPPER.wrap(guiGraphics, () -> this.parent.renderDefaultStyleOffhand(guiGraphics, partialTicks, player, screenWidth, screenHeight, prevItem, currentItem, nextItem));
        }

        @Override
        public void renderDetailedStyleOffhand(GuiGraphics guiGraphics, float partialTicks, LocalPlayer player, int screenWidth, int screenHeight, ItemStack prevItem, ItemStack currentItem, ItemStack nextItem) {
            AutoHudCompat.BACKGROUND_WRAPPER.wrap(guiGraphics, () -> this.parent.renderDetailedStyleOffhand(guiGraphics, partialTicks, player, screenWidth, screenHeight, prevItem, currentItem, nextItem));
        }
        ...
        @Override
        public void renderItem(GuiGraphics guiGraphics, int x, int y, float partialTicks, Player player, ItemStack stack, boolean doDecoration, boolean doBounce) {
            AutoHudCompat.ITEM_WRAPPER.wrap(guiGraphics, () -> this.parent.renderItem(guiGraphics, x, y, partialTicks, player, stack, doDecoration, doBounce));
        }
    }
}
